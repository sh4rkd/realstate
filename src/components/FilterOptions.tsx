    ...
    <div className="flex space-x-4 mb-6">
      ...
      <div className="relative w-32">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <img src={'/assets/icons/symbol.svg'} alt="Chevron Down" className="h-5 w-5 text-white" />
        </div>
      </div>
      <div className="relative w-40">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <img src={'/assets/icons/dropdown_active.svg'} alt="Chevron Down" className="h-5 w-5 text-white" />
        </div>
      </div>
      <div className="relative flex-grow">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <img src={'/assets/icons/dropdown_inactive.svg'} alt="Chevron Down" className="h-5 w-5 text-gray-400" />
        </div>
      </div>
      <div className="relative flex-grow">
        <input
        ...
        />
        <div className="absolute inset-y-0 right-0 flex items-center pr-3">
          <img src={'/assets/icons/settings.svg'} alt="Filter" className="h-5 w-5 text-gray-400" />
        </div>
      </div>
    </div>
  );
